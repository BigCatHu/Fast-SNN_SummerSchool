    ...
    def __init__(
        ...
        if float:
            ...
            self.layer8 = Dummy(nn.Sequential(nn.Conv2d(512, 512, 3, stride=2, padding=1),
                                              nn.BatchNorm2d(512),
                                              nn.ReLU(inplace=True)))	            
            self.layer9 = Dummy(nn.Sequential(nn.Linear(8192, 4096),
                                              nn.BatchNorm1d(4096),
                                              nn.ReLU(inplace=True)))
            self.layer10 = Dummy(nn.Sequential(nn.Linear(4096, 4096),
                                               nn.BatchNorm1d(4096),
                                               nn.ReLU(inplace=True)))
            self.layer11 = Dummy(nn.Linear(4096, 29))    
            ...
            self.layer8 = Dummy(nn.Sequential(QuantConv2d(512, 512, 3, stride=2, padding=1),
                                              nn.BatchNorm2d(512),
                                              QuantReLU(inplace=True)))	            
            self.layer9 = Dummy(nn.Sequential(QuantLinear(8192, 4096),
                                              nn.BatchNorm1d(4096),
                                              QuantReLU(inplace=True)))
            self.layer10 = Dummy(nn.Sequential(QuantLinear(4096, 4096),
                                               nn.BatchNorm1d(4096),
                                               QuantReLU(inplace=True)))
            self.layer11 = Dummy(last_fc(4096, 29))
...
class S_VGG11(nn.Module):
    def __init__(
        ...
        self.layer8 = Spiking(nn.Sequential(QuantConv2d(512, 512, 3, stride=2, padding=1),
                                            nn.BatchNorm2d(512),
                                            IF()), T)	            
        self.layer9 = Spiking(nn.Sequential(QuantLinear(8192, 4096),
                                            nn.BatchNorm1d(4096),
                                            IF()), T)
        self.layer10 = Spiking(nn.Sequential(QuantLinear(4096, 4096),
                                             nn.BatchNorm1d(4096),
                                             IF()), T)
        self.layer11 = last_Spiking(last_fc(4096, 29), T)  
