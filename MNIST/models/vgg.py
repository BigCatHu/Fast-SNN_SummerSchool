...
class VGG11(nn.Module):
    def __init__(
        ...
        if float:
            self.layer1 = Dummy(nn.Sequential(nn.Conv2d(1, 64, 3, stride=1, padding=1),
                                              nn.BatchNorm2d(64),
            ...
            self.layer1 = Dummy(nn.Sequential(first_conv(1, 64, 3, stride=1, padding=1),
                                              nn.BatchNorm2d(64),
...
class S_VGG11(nn.Module):
    def __init__(
        ...
        self.layer1 = Spiking(nn.Sequential(first_conv(1, 64, 3, stride=1, padding=1),
                                            nn.BatchNorm2d(64),
                                            IF()), T)
